...
//}
//}
// add for Doctor Image
//[HttpPost]
//[AllowAnonymous]
//[ApiExplorerSettings(IgnoreApi = true)]
//[Route("~/api/DoctorImageApi/ImageUpload")]
//public IActionResult DoctorImageUpload([FromBody] DoctorImageUploadModel model)
//{
//    if (model == null || string.IsNullOrWhiteSpace(model.FileBase64) || string.IsNullOrWhiteSpace(model.FileName))
//    {
//        return BadRequest(new { Status = false, Message = "Invalid file data" });
...
//    if (string.IsNullOrWhiteSpace(model.ImageIDP) || !int.TryParse(model.ImageIDP, out int employeeId) || employeeId <= 0)
//    {
//        return BadRequest(new { Status = false, Message = "Invalid ImageIDP" });
//    }
